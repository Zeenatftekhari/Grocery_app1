...
function FlashScreen() {
  ...
  return (
    <div style={containerStyle}>
      <h1 style={titleStyle}>Hello Welcome to Weekly Group by delivery</h1>
      <h2 style={subtitleStyle}> hope you have a great day</h2>
      <img src="/deliverypng.png" alt="Logo" style={imageStyle} />
