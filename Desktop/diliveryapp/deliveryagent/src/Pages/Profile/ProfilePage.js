...
export default function Profile() {
  ...
  const circleStyle = {
    ...
    position: "absolute",
    //zIndex: -1,
    top: "-10%", // Adjust this value to position the circle
    left: "48%",
  ...
  return (
    ...
    <div>
      <div style={formContainerStyle}>
        <div><div style={rectangleStyle}></div>
        </div>
        <div></div>
        <div style={titleStyle}>My Profile</div>   
        <div style={cardStyle}>
      <h1 style={titleStyle1}>User name</h1>
      <h2 style={circleStyle}>{circleSvg}</h2>
      </div>
      <div style={cardStyle1}>
        <h1 style={subtitleStyle}> Acceptance | Rejected</h1>
        <h1 style={subtitleStyle1}> 80% | 4</h1>
      </div>
